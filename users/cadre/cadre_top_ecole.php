  ...
  <body>
    ...
    <div class="mobile_nav">
      ...
      <div class="mobile_nav_items">
        <a href="dashboard_ecole.php"><i class="fas fa-desktop"></i><span>status</span></a>
    ...
    <div class="sidebar">
      ...
      <a href="dashboard_ecole.php" id="sidebar_link1"><i class="fas fa-desktop"></i><span>Status</span></a>
      <a href="../view/by_school/" id="sidebar_link4"><i class="far fa-comment"></i><span>Suivi</span></a>
